...
const AdminDashboardContent = () => {
  ...
  const [selectedTextForUpdate, setSelectedTextForUpdate] =
  ...
  const handleAddManualText = () => {
    const newText = new Text(
      ...
      (newManualText.isFiction
        ? newManualText.genre
        : newManualText.category) ?? Category.NATURE,
    ...
    if (currentText) {
      addText(
        new Text(
          ...
          currentText.isAI ? currentText.genre : currentText.category,
          "", // ID will be generated by Firebase
          Timestamp.fromMillis(Date.now()),
          Timestamp.fromMillis(Date.now()),
  ...
  const handleQuestionChange = (
    ...
    if (activeTab === "find") {
      setFoundTexts((prev) =>  updateQuestions(prev, currentTextIndex, questionIndex, field, value));
    } else {
      setGeneratedTexts((prev) => updateQuestions(prev, currentTextIndex, questionIndex, field, value));
    }
  };
  ...
  const updateDiscoveredText = (field: string, value: any) => {
    if (activeTab === "find") {
      setFoundTexts((prev) => {
        const updated = [...prev];
        const current = updated[currentTextIndex];
      ...
      <div className="bg-white p-6 rounded-xl shadow-2xl border border-gray-100">
        ...
        <div className="mb-8 p-6 bg-gray-50 rounded-xl border border-gray-200">
          <input
            ...
            onChange={(e) => updateDiscoveredText("title", e.target.value)}
          ...
          <textarea
            ...
            onChange={(e) => updateDiscoveredText("content", e.target.value)}
          ...
          <div className="mt-4 flex items-center justify-between text-sm text-gray-500">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                onChange={(e) => updateDiscoveredText("difficulty", e.target.value)}
