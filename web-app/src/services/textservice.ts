import { getFirestore, collection, getDocs, query, where, Timestamp, addDoc} from 'firebase/firestore/lite';
import { MY_APP } from '../firebaseconfig.js';

export class TextService {
    private db;

    constructor() {
        this.db = getFirestore(MY_APP);
    }
    ...
    async addText(category_: Category, content_: string, difficulty_: Difficulty, title_: string) {
